                    ...
                    <!--begin::Mixed Widget 1-->
                            <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                                ...
                                <div class="card-header border-0 bg-primary text-center py-5">
                                    <h3 class="card-title font-weight-bolder text-white text-center">Sales Stat</h3>
                                </div>
                                <!--end::Header-->
                                <!--begin::Body-->
                                    ...
                                    <div class="card-spacer mt-n25">
                                        ...
                                        <div class="row m-0">
                                            <div class="col-2 bg-light-warning px-6 py-8 rounded-xl mr-5">
                                                ...
                                                <a href="#" class="text-warning font-weight-bold font-size-h6">Total Siswa
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-2 bg-light-primary px-6 py-8 rounded-xl">
                                                <span class="svg-icon svg-icon-3x svg-icon-primary d-block my-2">
                                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Add-user.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
