...
@section('content')
    ...
    <div class="container">
        <div class="card card-custom">
            <div class="card-body">
                <h3 class="text-dark font-weight-bold mb-5 "><b>Data Pembayaran SPP Siswa</b></h3>
                <div class="row">
                    <div class="col-4">
                    ...
                    <div class="col-5 text-right">
                        {{-- <a href="" type="button" class="btn btn-primary"><i
                                class="flaticon2-add-1"></i><strong>Data Pembayaran</strong></a> --}}
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a onclick="confirmDelete(this)"
                                            data-url="{{ route('', ['id_grade' => $grade->id]) }}"><i
