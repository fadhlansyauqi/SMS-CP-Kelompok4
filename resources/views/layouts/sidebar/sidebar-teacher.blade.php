...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        ...
        <a href="index.html" class="brand-logo" onclick="return false;" onmouseover="this.style.pointerEvents='none';">
            <img alt="Logo" src="{{ asset('media-metronics/logos/sms-logo.png') }}" class="img-fluid"
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    ...
                    <a href="index.html" class="brand-logo" onclick="return false;"
                        ...
                        <img alt="Logo" src="{{ asset('media-metronics/logos/sms-logo.png') }}"
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <!--begin::Menu Nav-->
                        <ul class="menu-nav">
                            <li class="menu-item {{ Route::currentRouteNamed('teacher.dashboard') ? 'menu-item-active' : '' }}"
                                aria-haspopup="true">
